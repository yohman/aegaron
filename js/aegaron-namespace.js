	...
	apollo:   			
	{
		...
		RoyalNecropolis: {
			layer: new ol.layer.Tile({
				mapid: 1,
				source: new ol.source.XYZ({
					url: 'http://marinus.library.ucla.edu:6080/arcgis/rest/services/Apollo/RoyalNecropolis2/ImageServer/tile/{z}/{y}/{x}',
					maxZoom: 23
				}),
				visible: true
			}),
		...
		Uronart: {
			layer: new ol.layer.Tile({
				mapid: 1,
				source: new ol.source.XYZ({
					url: 'http://marinus.library.ucla.edu:6080/arcgis/rest/services/Apollo/Uronart3/ImageServer/tile/{z}/{y}/{x}',
					maxZoom: 23
				}),
				visible: true
			}),
